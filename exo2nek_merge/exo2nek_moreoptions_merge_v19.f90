! Haomin Yuan, 10/1/2019
! Update:
! add CHT feature.
! In ICEM, must have fluid volume mesh first.
! then, create solid volume mesh.
! in exo file, different types of elements are always put in different blocks
! and sequence are followed: tet,hex,wedge
! fluid mesh are always put first, then sold mesh.
! let's say some example scenario:
! 
! 1st fluid tet, 2nd fluid hex, 3rd fluid wedge, 4th solid tet, 5th solid hex, 6th solid wedge
! 
! 1st fluid tet, 2nd fluid wedge, 3th solid tet, 4th solid wedge
! 
! 1st fluid tet, 2th solid tet
!------------------------------------------------------------------------
      program exo2nek
      ...
      write(6,*) 'Special exo2nek version to merge multiple fluid exo files'
      write(6,*) 'notes: for 3D mesh only'
      write(6,*) 'notes: DO NOT assign SideSet to interface surface mesh'
      ...
      write(6,*) 'do you have more exo file? y/n'
      read (5,*) ifmore 
      if(ifmore.eq.'y') then
         ifmorefluid =.true.
      ...
      write(6,*) 'please input combined re2 file name:'
      call read_re2_name
      call gen_re2

      write(6,*) 'please assign actual boundary condition tag in usrdat2()'
      write(6,*) 'usr should differentiate sidesets for different exo files'
...
! -------------------------------------------------------------------
! all blow part is direct adopted from origin exo2nek.f90, totally unchanged
!-----------------------------------------------------------------------
