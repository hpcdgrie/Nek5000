...
cc assume all element to be TRTRA4 and WEDGE6
cc TRTRA4 elements in block 1
cc WEDGE6 elements in block 2, one WEDGE6 exo element is converted to 3 hex20 nek elements.
      call read_input_name
      call exodus_read_new ! exodus_read_new does not check element type in exodus file.
      call split_convert1

      elseif(option.EQ.3) then
cc assume all element to be HEX8 TRTRA4 and WEDGE6
cc TRTRA4 elements in block 1
cc HEX8 elements in block 2, one HEX8 exo element is converted into 8 hex20 nek elements
cc WEDGE6 elements in block 3, one WEDGE6 exo element is converted to 6 hex20 nek elements.
c
...
c split 1 TETRA4 to 4 HEX20
C split 1 WEDGE6 to 3 HEX20
C
...
cc tet,hex,wedge
      ...
      integer i,ihex,ifc,iss
      integer ivert,inekvert
